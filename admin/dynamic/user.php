      ...
      <div class="container-fluid">
        <div class="row">
          <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <center><h2>Licenciatura:<br><br><p class="bg-info"> <?php echo $content2[4]?></p></h2></center>
           </nav>

           <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
            <blockquote class="blockquote">
              <center><h2><p class="bg-info">Bienvenido: <?php echo utf8_encode($content2[1])." ".utf8_encode($content2[2])?></p></h2></center>
            </blockquote>
